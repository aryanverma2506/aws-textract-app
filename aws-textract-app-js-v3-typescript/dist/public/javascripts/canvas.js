...
const canvasUpdate = document.getElementById("canvas-update");
const colorPicker = document.getElementById("color-picker");
const bgColorPicker = (document.getElementById("bg-color-picker"));
const controlPencilSize = (document.getElementById("control-pencil-size"));
const controlEraserSize = (document.getElementById("control-eraser-size"));
...
const clearCanvasCache = (document.getElementById("clear-canvas-cache"));
...
function createCanvas() {
    canvas.width = +document.getElementById("sizeX").value;
    canvas.height = +document.getElementById("sizeY").value;
...
// STORE DRAWING DATA
function storeDrawing(x, y, size, color, stroke) {
...
function startDrawing(event) {
    ...
    if (isDrawing) {
        const currentPosition = canvasMousePos(event);
        canvasCtx.beginPath();
        ...
        canvasCtx.stroke();
        storeDrawing(currentPosition.x, currentPosition.y, currentSize, useTool === "ERASER" ? currentBg : currentColor, false);
    }
}
// CONTINUE DRAWING
function continueDrawing(event) {
    if (isDrawing) {
        ...
        canvasCtx.lineTo(currentPosition.x, currentPosition.y);
        canvasCtx.stroke();
        storeDrawing(currentPosition.x, currentPosition.y, currentSize, useTool === "ERASER" ? currentBg : currentColor, true);
    }
}
// STOP DRAWING
...
// FILE PICKER HANDLER
function filePickerHandler(event) {
...
function canvasFormSubmitHandler(event) {
...
//# sourceMappingURL=../../../maps/public/javascripts/canvas.js.map